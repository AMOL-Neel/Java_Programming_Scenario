...
public class Parameter {
	 ...
	 * 
	 * int, short, byte, boolean, float, classtype ---254 for non static 
	 * 255 for static method
	 * 
	 * double , long --- 127 static and non static both
	 * 
	 */
	public static void testing(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9, int a10, int a11,
			...
			int a247, int a248, int a249, int a250, int a251, int a252, int a253, int a254, int a255) {
